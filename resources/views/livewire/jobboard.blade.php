            ...
            @foreach ($jobs as $job)
                <a href="/viewjob/{{ $loop->index }}" class="">
                    <div class="border border-gray-200 rounded-xl shadow-md p-3">
                        ...
                        <div class="flex space-x-2">
                            <div class="text-green-800"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex space-x-2">
                            <div class="text-yellow-400"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
